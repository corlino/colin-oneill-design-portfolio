                        ...
                        >
                            <div className="flex w-full items-center">
                                <motion.button
                                    ...
                                    className="h-10 w-10 shrink-0 -mr-3 rounded-full border border-gray-300 bg-white text-gray-700 hover:bg-gray-100"
                                ...
                                <motion.button
                                    ...
                                    className="h-10 w-10 shrink-0 -ml-3 rounded-full border border-gray-300 bg-white text-gray-700 hover:bg-gray-100"
                                    whileHover={{ scale: 1.06 }}
                                    whileTap={{ scale: 0.94 }}
                                >
