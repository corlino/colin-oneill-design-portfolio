...
export default function HomePage() {
    ...
    return (
        ...
        <div className="min-h-screen">
            ...
            <section id="process" className="relative z-10 scroll-mt-28 py-20 px-8 min-h-[70vh] sm:min-h-[80vh] md:min-h-[90vh]">
            ...
            <footer className="py-12 border-t border-gray-100">
                ...
                >
                    ...
                    {/* <Link href="/projects/testingpage" className="block text-gray-600 hover:text-gray-900 text-base transform transition-transform duration-200 hover:scale-110 hover:font-medium">
                        Testing
</Link>  add /projects/testingpage at the end of the link*/}
                </motion.div>
            </footer>
        </div>
    )
